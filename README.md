...
### Requires [Sign](https://github.com/Lodestones/Sign/)
...
And this plugin is not meant to be used on survival servers. Inventory in particular is no longer an issue during games. It saves in between games.

## Plans

- [X] Player Statistic Registry
- [X] Achievement and/or Challenge Registry
- [X] Map Voting
...
- [X] Spectate Command
- [X] Nicknames
- [X] Tablist Nametag/Header/Footer Control
- [ ] Tablist Categories
- [ ] Make spectators unable to swap worlds while watching a game